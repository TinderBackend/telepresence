...
import (
	...
	manager "github.com/TinderBackend/telepresence/v2/cmd/traffic/cmd/manager/internal/state"
	testdata "github.com/TinderBackend/telepresence/v2/cmd/traffic/cmd/manager/internal/test"
)
